...
- **Pourcentage sur de petits échantillons**:  Méfiez-vous des statistiques "époustouflantes" ! Les journaux, les magazines et autres médias font souvent état de changements rapides dans la société. 
    ...
    - Par exemple, nous pouvons lire dans le journal local que le taux d'homicide de notre communauté a augmenté de 50 % par rapport à l'année précédente. Cela peut être une source d'inquiétude ou non. 
