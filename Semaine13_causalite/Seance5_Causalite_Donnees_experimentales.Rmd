---
title: 'Section 5: Causalité à partir de données expérimentales'
...
```{r BC1, echo=FALSE, fig.cap="A caption", out.width = '80%'}
knitr::include_graphics("Breast_cancer1.jpg")
```
...
```{r BC2, echo=FALSE, fig.cap="A caption", out.width = '50%'}
knitr::include_graphics("Breast_cancer2.jpg")
```
