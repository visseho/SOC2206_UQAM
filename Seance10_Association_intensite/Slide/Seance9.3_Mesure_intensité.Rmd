---
title: "Seance 10: Mesure de l'intensité de l'association entre deux variables catégorielles"
...
## Rappel : comment faire un test de chi-carré?
...
>3. Trouvez votre degré de liberté (r-1)(c-1)

>4. Trouvez la valeur minimale du **chi-deux** pour rejeter l'hypothèse nulle
...
## Rappel: Conditions de validité du test

> 1. Condition 1 :  La fréquence totale du tableau de contingence (N) doit être supérieur ou égal à 30

> 2. Condition 2 :  Les fréquences marginales du tableau de contingence (Ni. ou N.j) doivent toujours être supérieur ou égal à 5.

> 3. Condition 3 :  La fréquence anticipée des  cases du tableau de contingence doit être supérieur à 5 dans 80% des cases du tableau de contingence.


## Remarques


>1. Remarque: Le test du Chi-2 est relativement robuste, ce qui signifie que ses conclusions demeurent en général valide, même lorsque les hypothèses de base ne sont pas tout à fait respectée.
 
>2. Une relation statistiquement significative n'est pas toujours une **signification substantielle**. Avec une grande taille d'échantillon, les très petites différences peuvent être significatives

>3. Le test de chi-deux est basé sur un échantillon issu d'une procédure d'échantillonnage probabilistique.

## Labo


Mesures de l'intensité d'association
======================================
...
![lambda](../../images/mesure_association.jpg){width=80%}
