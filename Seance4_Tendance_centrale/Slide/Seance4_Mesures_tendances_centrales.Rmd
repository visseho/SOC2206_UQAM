---
title: 'Séance 4: Mesures de tendances centrales'
subtitle: "Et Séance 5: Mesures de dispersion (à venir)"
...
1. Description statistique des variables quantitatives
  - Paramètres de position
  - Paramètres de dispersion (prochain cours)


Description statistique des variables qualitatives (rappel)
=========================================================
...
Les variables sont décrites numériquement par :
...
Ces données peuvent être regroupées en (les parenthèses font références aux formules en haut):

- 6 ($x_1$) --> 1 ($n_1$) ==> fréquence relative 1/10
- 7 ($x_2$) --> 3 ($n_2$) ==> fréquence relative 3/10
- 8 ($x_3$) --> 3 ($n_3$) ==> fréquence relative 3/10
- 9 ($x_4$) --> 2 ($n_4$) ==> fréquence relative 2/10
- 10 ($x_5$) --> 1 ($n_5$) ==> fréquence relative 1/10
...
- Il n'y a pas de fonction pour le mode
- Je vous montrerai en classe comment cela se calcule.
...
age_variance <-  var(age)
age_variance

age_ecart_type <- sd(age)
age_ecart_type
