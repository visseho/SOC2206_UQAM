...
2. Quel test est le plus approprié? Pourquoi?
3. L'erreur type de la différence entre les moyennes
4. La statistique t
5. La différence entre les majors en mathématiques et les majors en philosophie est-elle statistiquement significative au niveau de signification de 1%? Expliquer.
...
**4. La différence entre la majeure en mathématiques et la majeure en philosophie est-elle statistiquement significative au niveau de signification de 1%? Expliquer.**
...
On va travailler avec la vrariable `beat_burnfood`.

1. Calculer la moyenne de cette variable selon les régions
2. Est-ce qu'il existe une différence significative entre les régions? Utiliser le test de Student pour répondre à cette question.
3. Votre conclusion

## Test t

Créer une nouvelle base de données qui limite vos données aux région de l'Afrique et de l'Asie. Nommez-la Afrique_Asie. Elle comprend combien d'observations?

1. Présenter un graphique qui montre la relation entre la variable `beat_burnfood` et `region`
2. Est-ce que la différence observée est due au hasard? 
3. Testé cela au niveau de signification de 5% ? Prenez soin de bien présenter votre hypothèse nulle et votre hypothèse alternative. Faites cela à la main et ensuite avec R.
